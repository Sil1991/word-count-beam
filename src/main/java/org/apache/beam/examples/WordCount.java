...
//     .apply("WriteCounts", TextIO.write().to(options.getOutput()));
        ...
        p.apply("ReadLines", TextIO.read().from("gs://jasonlai_bucket1/JasonLai/input/a.csv"))
//            .apply("ReadLines", TextIO.read().from("gs://jasonlai_bucket1/JasonLai/input/a.csv"))
                .apply("Writing1", TextIO.write().to("gs://jasonlai_bucket1/JasonLai/output/a1").withSuffix(".csv").withoutSharding());
//     .apply("Writing1", TextIO.write().to(options.getOutput()).withSuffix(".csv"));
        ...
        p1.apply("ReadLines1", TextIO.read().from("gs://jasonlai_bucket1/JasonLai/input/a.csv"))
                .apply("writing2", TextIO.write().to("gs://jasonlai_bucket1/JasonLai/output/a1").withSuffix(".csv").withoutSharding());
    }
}
